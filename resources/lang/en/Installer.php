...
return array(
    ...
    'setup_completed_already_message' => "An install file has been detected which means setup process has already completed. <br /> If you haven't setup a default user you can " .
